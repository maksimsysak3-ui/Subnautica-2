...
The library is 82 procedural buildings across four zones. Everything below is
...
| zone | count | range |
| --- | --- | --- |
| residential | 29 | detached house → 20-storey clad tower |
| commercial | 22 | takeaway row → shopping mall |
| office | 13 | business park unit → 87 m deco tower |
| industrial | 18 | craft units → grain store |

Budget: 1,000 triangles minimum (below that an asset has not been detailed and
it shows next to its neighbours), 10,000 maximum, mean 2,429 at LOD0. Three
