...
const PATHS: Record<string, string> = {
  // Natural resources. Each one a thing a player recognises at twelve pixels:
  // a wheat ear, a conifer, crystals in rock, a derrick, cut blocks, a fish.
  resources: 'M2.5 20.5 9.5 7l4.2 7.5 2.3-3.5 5.5 9.5zM15.2 17.6l1.4-1.6 1.4 1.6-1.4 1.6z',
  crop: 'M12 21V4.5'
    + 'M12 8.5c-2.2-.3-3.6-1.9-3.6-4 2.2.3 3.6 1.9 3.6 4zM12 8.5c2.2-.3 3.6-1.9 3.6-4-2.2.3-3.6 1.9-3.6 4z'
    + 'M12 13c-2.2-.3-3.6-1.9-3.6-4 2.2.3 3.6 1.9 3.6 4zM12 13c2.2-.3 3.6-1.9 3.6-4-2.2.3-3.6 1.9-3.6 4z'
    + 'M12 17.5c-2.2-.3-3.6-1.9-3.6-4 2.2.3 3.6 1.9 3.6 4zM12 17.5c2.2-.3 3.6-1.9 3.6-4-2.2.3-3.6 1.9-3.6 4z',
  timber: 'M12 2.8 7 9.2h2.8L6 14.6h3.6L6.2 19.4h11.6l-3.4-4.8H18l-3.8-5.4H17zM12 19.4v2.3',
  ore: 'M3.5 21h17M6.8 21 4.6 15.2l2.6-5.8 2.7 5.8L7.9 21zM14.4 21l-2.6-6.6L15 4.8l3.4 9.6L16 21z',
  oil: 'M7.5 21 11 3.5h1L15.5 21M8.7 15h5.6M9.9 9.6h3.2M5 21h13'
    + 'M19 11.6c1 1.3 1.7 2.2 1.7 3.1a1.7 1.7 0 0 1-3.4 0c0-.9.7-1.8 1.7-3.1z',
  stone: 'M3 20.5h18M4.2 20.5v-5.2h7.3v5.2M12.5 20.5v-5.2h7.3v5.2M7.8 15.3v-5.2h8.4v5.2',
  fish: 'M5.5 12c2.6-3.4 5.6-5.2 9-5.2 2.8 0 5 1.7 6.5 5.2-1.5 3.5-3.7 5.2-6.5 5.2-3.4 0-6.4-1.8-9-5.2z'
    + 'M5.5 12 2.5 8.4v7.2zM16.6 10.6h.01',
  ...
  metro: 'M12 2.8a9.2 9.2 0 1 0 .01 0M7.2 16.5V8.2l4.8 5.2 4.8-5.2v8.3',
  ...
  district: 'M4 6.5l5-2.5 6 2.5 5-2.5v13.5l-5 2.5-6-2.5-5 2.5zM9 4v13.5M15 6.5V20',
