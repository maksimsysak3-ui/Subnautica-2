...
const GLYPH: Record<Branch, string> = {
  ...
  fire: 'M24 3.5 C 23 10 18 13 15 18 C 13.4 21 12.6 24.4 12.6 27.9 '
      ...
      + 'C 35.4 23.3 33.9 19.5 31 15.8 C 29.8 18.4 28.4 19.7 26.9 19.7 '
      + 'C 24.7 19.7 23.9 17 23.9 13.5 C 23.9 9.8 24.2 6 24 3.5 Z '
      + 'M24 26.2 C 21.1 28.8 19.6 31.6 19.6 34.4 C 19.6 37.6 21.6 40 24 40 '
      + 'C 26.4 40 28.4 37.6 28.4 34.4 C 28.4 31.6 26.9 28.8 24 26.2 Z',
