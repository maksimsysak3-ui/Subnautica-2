...
.mr-modtools[hidden], .mr-skypanel[hidden], .mr-mods-reload[hidden] { display: none; }
...
body.is-photo #overlay > *:not(.mr-modtools):not(.mr-letterbox) { opacity: 0 !important; pointer-events: none !important;
