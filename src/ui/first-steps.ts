...
const CHAPTERS: readonly Chapter[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { title: 'Specialise in an industry',
        how: 'Industry opens at level 3: pick a headquarters for what your ground holds -- see the Natural resources view.',
        done: (_s, c) => c.world.industry.hqs.length > 0 },
      { title: 'Draw its harvest area',
  ...
  },
  {
    ...
    steps: [
      ...
      { title: 'Upgrade a service building',
        how: 'Click a school, clinic or plant with free ground beside it, and build its extension wing.',
        done: (_s, c) => c.world.lots.some((l) => (l.tier ?? 0) > 0) },
