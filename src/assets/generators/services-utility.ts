...
export const UTILITY: AssetDef[] = [
  ...
  { id: 'svc.water.sewage', name: 'Sewage works', zone: 'service', branch: 'sewage', density: 'none', variant: 'sculpted', footprint: [12, 9], height: 19.6, brand: { name: 'Water', colour: [0.16, 0.52, 0.62], accent: [0.70, 0.72, 0.74], sign: 'box' }, sim: util(60, 1100, 620, 0), note: 'Four circular clarifiers with scraper bridges, a bank of aeration lanes, two domed sludge digesters, an inlet screen house and a control block, tied together with pipe runs.', build: sewageWorks },
  { id: 'svc.water.treatment', name: 'Treatment works', zone: 'service', branch: 'sewage', density: 'none', variant: 'sculpted', footprint: [6, 5], height: 13.0, brand: { name: 'Water', colour: [0.16, 0.52, 0.62], accent: [0.70, 0.72, 0.74], sign: 'box' }, sim: util(22, 420, 300, 0), note: 'Two clarifiers with rotating bridges, a baffled aeration lane, sludge tank and pipe bridge.', build: treatmentWorks },
