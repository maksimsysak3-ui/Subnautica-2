...
export const OFFICE: AssetDef[] = [
  ...
  { id: 'off.atrium', name: 'Atrium block', zone: 'office', density: 'medium', variant: 'sculpted', footprint: [4, 4], height: 14.8, brand: BRANDS.bank, sim: desk(220, 240), note: 'Four wings round a glazed courtyard, expressed floor bands, glazed lobby.', build: atriumBlock },
  { id: 'off.studio', name: 'Creative studio', zone: 'office', density: 'low', variant: 'sculpted', footprint: [4, 3], height: 11.0, brand: BRANDS.bookshop, sim: desk(70, 90), note: 'Brick base with tall industrial openings, clad upper storey, sawtooth north light.', build: studio },
  { id: 'off.civic', name: 'Civic offices', zone: 'office', density: 'medium', variant: 'sculpted', footprint: [4, 4], height: 20.4, brand: BRANDS.bank, sim: desk(200, 130), note: 'Stone block with a columned centre bay, wide flight of steps, flag on the roof.', build: civicOffice },
  ...
  { id: 'off.data', name: 'Data centre', zone: 'office', density: 'medium', variant: 'sculpted', footprint: [5, 4], height: 15.4, brand: BRANDS.electronics, sim: desk(40, 900), note: 'Blind clad envelope, louvre bands, screened cooling compound and a generator yard.', build: dataCentre },
];
